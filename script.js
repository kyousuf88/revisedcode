...
function generateResume() {
    ...
    document.querySelectorAll('.education').forEach((edu) => {
        const degree = edu.querySelector('input').value;
        const school = edu.querySelectorAll('input')[1].value;
    ...
    document.querySelectorAll('.experience').forEach((exp) => {
        const title = exp.querySelector('input').value;
        const company = exp.querySelectorAll('input')[1].value;
